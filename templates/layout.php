...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-lg">
        <div class="container-fluid d-flex align-items-center">
            <a class="navbar-brand fs-2 p-0" href="<?= $this->url('about/index') ?>">ORGANIZER</a>
            ...
            <?php if ($this->webUser()->isAuthenticated()): ?>
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?= $this->url('auth/logout') ?>">Logout</a></li>
                    </ul>
                </div>
            <?php else: ?>
                <a href="<?= $this->url('auth/login') ?>" class="btn btn-dark ms-auto" style="width: 100px;">Login</a>
            <?php endif; ?>
        </div>
    </nav>
    <div class="container">
